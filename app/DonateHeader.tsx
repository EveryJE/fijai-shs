 ...
 */
export function DonateHeader({ title, description, organizationName = "Fijai SHS Alumni Institutional Fund" }: DonateHeaderProps) {
    return (
        <div className="bg-[url('/school-gate.jpg')] bg-cover bg-center rounded-xl border border-[#dadce0] overflow-hidden shadow-sm mb-6">
            ...
            <div className="p-6 md:p-8 space-y-4">
                ...
                <div className="space-y-2">
                    <h1 className="text-3xl md:text-4xl font-bold text-[#202124] tracking-tight">{title}</h1>
                    {description && (
