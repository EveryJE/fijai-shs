...
export type UseDropzoneProps<TUploadRes, TUploadError> = {
  onDropFile: (
    file: File,
  ) => Promise<
...
export const useDropzone = <TUploadRes, TUploadError = string>(
  ...
  const canRetry = useCallback(
    (id: string) => {
      const fileStatus = (fileStatuses as any[]).find((file) => file.id === id);
      return (
...
export const Dropzone = <TUploadRes, TUploadError>(
...
export interface DropZoneAreaProps extends React.ButtonHTMLAttributes<HTMLButtonElement> { }
export const DropZoneArea = forwardRef<HTMLButtonElement, DropZoneAreaProps>(
...
export const DropzoneDescription = forwardRef<
...
export const DropzoneFileList = forwardRef<HTMLOListElement, DropZoneFileListProps>(
  (props, ref) => {
    const context = useDropzoneContext();
    if (!context) {
...
export interface DropzoneFileListItemProps<TUploadRes, TUploadError>
  extends React.LiHTMLAttributes<HTMLLIElement> {
  file: FileStatus<TUploadRes, TUploadError>;
  children?: React.ReactNode;
}

export const DropzoneFileListItem = forwardRef<
  HTMLLIElement,
...
export interface DropzoneFileMessageProps
  extends React.HTMLAttributes<HTMLParagraphElement> { }

export const DropzoneFileMessage = forwardRef<
  HTMLParagraphElement,
...
export interface DropzoneMessageProps
  extends React.HTMLAttributes<HTMLParagraphElement> { }

export const DropzoneMessage = forwardRef<HTMLParagraphElement, DropzoneMessageProps>(
  (props, ref) => {
    const { children, ...rest } = props;
    const context = useDropzoneContext();
    if (!context) {
...
export interface DropzoneRemoveFileProps extends React.ComponentProps<"button"> {
  className?: string;
  children?: React.ReactNode;
}

export const DropzoneRemoveFile = forwardRef<
  HTMLButtonElement,
...
export interface DropzoneRetryFileProps extends React.ComponentProps<"button"> {
  className?: string;
  children?: React.ReactNode;
}

export const DropzoneRetryFile = forwardRef<HTMLButtonElement, DropzoneRetryFileProps>(
  ({ className, children, ...props }, ref) => {
    const context = useDropzoneFileListContext();
...
export const DropzoneTrigger = forwardRef<HTMLLabelElement, DropzoneTriggerProps>(
  ({ className, children, ...props }, ref) => {
    const context = useDropzoneContext();
    if (!context) {
