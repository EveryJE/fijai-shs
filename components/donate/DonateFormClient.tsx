 ...
 * Replaces the monolithic layout with a high-fidelity 'Google Form' experiential flow.
 */
  ...
  return (
    ...
    >
      <div className="max-w-3xl shad mx-auto px-4 md:px-6 pt-4 min-h-screen bg-white/50 backdrop-blur-sm">
        ...
        {/* Branding Footer */}
        <div className=" text-center font-playfair animate-pulse opacity-40">
          Powere By KoalaKlick
        </div>
